...
\begin{center}
    \begin{tikzpicture}[scale=1.0]
        ...
        \addplot[thick, diagramprimary, domain=0:12, samples=100] {0.5*erfc(sqrt(10^(x/10)))};
        \addlegendentry{Uncoded QPSK}
        
        \addplot[thick, diagramsecondary, domain=0:12, samples=100, dashed] {0.5*erfc(sqrt(10^((x+8)/10)))};
