% % filepath: /Users/rowan/VSCode/chimera/book/latex/chapters/53-Non-Linear-Biological-Demodulation.tex
...
% Input signals
\draw[->,thick,blue!70!black] (1,0) -- (1,2) node[above,font=\scriptsize] {$f_1$};
\draw[->,thick,blue!70!black] (2.5,0) -- (2.5,1.5) node[above,font=\scriptsize] {$f_2$};
...
% % Original signals
% \draw[->,thick,blue!70!black] (1,0) -- (1,1.5) node[above,font=\scriptsize] {$f_1$};
% \draw[->,thick,blue!70!black] (2.5,0) -- (2.5,1.2) node[above,font=\scriptsize] {$f_2$};

% % Harmonics
% \draw[->,thick,red!70!black] (2,0) -- (2,0.6) node[above,font=\scriptsize] {$2f_1$};
% \draw[->,thick,red!70!black] (5,0) -- (5,0.5) node[above,font=\scriptsize] {$2f_2$};

% % IMD products
% \draw[->,thick,green!60!black] (0.5,0) -- (0.5,0.8) node[above,font=\scriptsize] {$|f_1-f_2|$};
% \draw[->,thick,green!60!black] (3.5,0) -- (3.5,0.7) node[above,font=\scriptsize] {$f_1+f_2$};

% \node[below,font=\small] at (3,-0.4) {\textbf{Output Spectrum}};
% \node[below,font=\scriptsize,blue!70!black] at (3,-0.8) {Blue: Fundamentals};
% \node[below,font=\scriptsize,red!70!black] at (3,-1.1) {Red: Harmonics};
% \node[below,font=\scriptsize,green!60!black] at (3,-1.4) {Green: IMD Products};
% \end{scope}
% \end{tikzpicture}
% \end{center}
...
% \fill[green!50!black!70] (0.5,2.5) rectangle (5.5,3);
...
% % Status
% \node[font=\small,green!50!black] at (3,0.8) {\textbf{✓ ESTABLISHED}};
...
% % Status
% \node[font=\small,red!70!black] at (3,0.8) {\textbf{? SPECULATIVE}};
...
% \draw[thick, dashed, blue!70!black] ([xshift=-0.3cm, yshift=0.5cm]heating.north west) rectangle ([xshift=0.3cm, yshift=-0.5cm]acoustic.south east);
% \node[above, blue!70!black, font=\scriptsize] at ([yshift=0.5cm]expansion.north) {EM $\rightarrow$ Acoustic Transduction};
% \end{tikzpicture}
% \end{center}
...
% \begin{tabular}{@{}lllll@{}}
% \toprule
% \textbf{Phenomenon} & \textbf{Frequency Range} & \textbf{Mechanism} & \textbf{Strength} & \textbf{Status} \\
% \midrule
% \textbf{Acoustic heterodyning} & kHz-MHz (ultrasound) & Acoustic nonlinearity ($\beta \sim 5$) & Strong & Established \\
% \textbf{Frey effect} & 1-10 GHz (microwaves) & Thermoelastic transduction & Moderate & Established \\
% \textbf{EM IMD} & GHz-THz & Dielectric nonlinearity ($\chi^{(3)}$) & Weak & Speculative \\
% \bottomrule
% \end{tabular}
% \end{center}
...
% % TEMPORARILY COMMENTED OUT - References section causing build issues
