...
The presence of the Earth's magnetic field makes the ionosphere an anisotropic medium, causing the polarisation plane of a linearly polarized wave to rotate. This \keyterm{Faraday rotation} is proportional to $1/f^2$ and can cause severe signal loss if the receiver antenna is not aligned with the rotated polarisation.
\begin{warningbox}
