...
\begin{description}
    ...
    \item[2. Pulse Shaping & DAC] The discrete symbols are converted into smooth analog waveforms, $I(t)$ and $Q(t)$, by digital-to-analog converters (DACs).
...
\begin{description}
    ...
    \item[3. ADC & DSP] The analog $I(t)$ and $Q(t)$ are sampled by analog-to-digital converters (ADCs), and the resulting digital IQ stream is then passed to the DSP for demodulation, error correction, and decoding.
\end{description}
