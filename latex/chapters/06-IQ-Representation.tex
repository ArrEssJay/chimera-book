...
\begin{importantbox}[title={Further Reading}]
    ...
    \begin{description}
        ...
        \item[Synchronization] (\Cref{ch:synchronisation}) covers the critical DSP algorithms for estimating and correcting carrier frequency and phase offsets in the received IQ signal.
