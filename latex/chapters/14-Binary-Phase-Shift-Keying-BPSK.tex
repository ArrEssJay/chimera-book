...
\begin{importantbox}[title={Further Reading}]
    ...
    \begin{description}
        ...
        \item[Carrier Recovery] (\Cref{ch:sync}) provides a deep dive into the practical implementation of the Costas and squaring loops required for coherent BPSK demodulation.
