...
\draw[->, thick, red!70!black, decorate, decoration={snake, amplitude=0.8mm, segment length=3mm}] 
  (-5,0.1) .. controls (-3,0.2) and (-1,0.15) .. (1,0.1);
\node[red!70!black, font=\sffamily\small] at (-2,0.7) {\textbf{Ground Wave}};
\node[red!70!black, font=\scriptsize] at (-2,0.3) {LF/MF (30 kHz--3 MHz)};

% Sky Wave - Ionosphere layer
\draw[blue!30, thick] (-6,4) -- (6,4);
\fill[blue!10, opacity=0.5] (-6,4) rectangle (6,4.3);
\node[blue!50!black, font=\scriptsize] at (0,4.5) {Ionosphere (60--400 km)};
...
\draw[->, thick, blue!70!black, decorate, decoration={snake, amplitude=0.8mm, segment length=3mm}] 
  (-1.8,3.8) -- (0.5,0.1);
\node[blue!70!black, font=\sffamily\small] at (-1,2.5) {\textbf{Sky Wave}};
\node[blue!70!black, font=\scriptsize] at (-1,2) {HF (3--30 MHz)};

% Line-of-Sight
\draw[->, thick, green!50!black, decorate, decoration={snake, amplitude=0.8mm, segment length=3mm}] 
  (2,1.5) -- (5,1.5);
\node[green!50!black, font=\sffamily\small] at (3.5,2) {\textbf{Line-of-Sight}};
\node[green!50!black, font=\scriptsize] at (3.5,1) {VHF+ ($>$30 MHz)};
