...
% The Python AMC simulator code block below has been temporarily commented out to allow the book to build.
% Issue: Very long Shaded environment (130+ lines) with complex syntax highlighting

\begin{center}
\textit{[AMC simulator code temporarily removed - see digital version or future edition]}
\end{center}
