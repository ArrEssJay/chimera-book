...
% TODO: Fix long code block - currently causes build hang
% The Python mmWave path loss calculator code block below has been temporarily commented out to allow the book to build.
% Issue: Very long Shaded environment (100+ lines) with complex syntax highlighting
