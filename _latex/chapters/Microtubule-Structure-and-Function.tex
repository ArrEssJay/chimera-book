...
\textbf{Function:} Provide structural support to maintain cell shape and mechanical rigidity.
...
\textbf{Force generation}: Depolymerization at kinetochores pulls chromosomes toward poles:
\begin{equation}
...
\textbf{Structure}: \textbf{9+2 axoneme} (9 doublet microtubules + 2 central singlets). Dynein arms on doublets cause sliding $\rightarrow$ bending motion.
...
\subsection{Neuronal Cytoskeleton Organization}\label{neuronal-cytoskeleton-organization}
...
\subsection{Post-Translational Modifications (PTMs)}\label{post-translational-modifications-ptms}
...
\subsection{Microtubule-Associated Proteins (MAPs)}\label{microtubule-associated-proteins-maps}
...
\section{Quantum Hypotheses (Speculative)}\label{sec:quantum-hypotheses}
...
\subsection{Orch-OR Theory (Penrose-Hameroff)}\label{orch-or-theory-penrose-hameroff}

\textbf{Hypothesis:} Microtubules perform quantum computations beyond classical neuron networks, potentially serving as substrates for consciousness.
...
\subsection{Evolutionary and Functional Arguments}\label{evolutionary-arguments}
...
\section{Proposed Experiments}\label{proposed-experiments}
