...
\draw[->] (-0.5,0) -- (8.5,0) node[right] {\sffamily\small Configuration};
...
\node[below=1.5cm of cable, font=\scriptsize, align=center] {
...
% Phase noise (near carrier) - simplified curve to avoid numerical overflow
\draw[thick, orange] (4.2,1.9) .. controls (4.4,2.5) and (4.6,3.5) .. (4.8,4.0);
\draw[thick, orange] (5.2,4.0) .. controls (5.4,3.5) and (5.6,2.5) .. (5.8,1.9);
\node[orange, font=\scriptsize] at (5,4.3) {Phase};
