...
% Time annotations
\node[font=\scriptsize,align=left] at (11,0) {$\tau_0$ (direct)};
\node[font=\scriptsize,align=left] at (11,1.5) {$\tau_1 > \tau_0$};
\node[font=\scriptsize,align=left] at (11,-1.5) {$\tau_2 > \tau_0$};
...
\begin{calloutbox}{Example: Deep Fade Probability}
