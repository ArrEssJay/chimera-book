...
\node[below,font=\scriptsize] at (5,1) {$\mu$m};
\node[below,font=\scriptsize] at (7,1) {700~nm};
\node[below,font=\scriptsize] at (9,1) {100~nm};
\node[below,font=\scriptsize] at (11,1) {1~nm};
\node[below,font=\scriptsize] at (13,1) {pm};
