...
\begin{center}
\begin{tikzpicture}[
  block/.style={rectangle, draw, minimum width=2.8cm, minimum height=0.9cm, font=\sffamily\small, align=center},
  arrow/.style={->, thick},
  node distance=1.6cm
]
...
% Noise and SNR
\node[block, right of=rxpower, node distance=4cm, fill=yellow!10] (noise) {Thermal\\Noise $N$};
...
% Labels
\node[right of=tx, node distance=4cm, font=\scriptsize, text width=2.2cm, align=left] {Add gains\\(in dB)};
\node[right of=fspl, node distance=4cm, font=\scriptsize, text width=2.2cm, align=left] {Subtract\\losses\\(in dB)};
\node[right of=rxgain, node distance=4cm, font=\scriptsize, text width=2.2cm, align=left] {Add gain\\(in dB)};
...
\node[above,font=\sffamily\bfseries\small] at (0,2.0) {BPSK (1 bit/symbol)};
\draw[->] (-1.6,0) -- (1.6,0) node[right,font=\scriptsize] {$I$};
\draw[->] (0,-1.3) -- (0,1.3) node[above,font=\scriptsize] {$Q$};
\draw[very thin,gray!20] (-1.3,-1.0) grid[step=0.3] (1.3,1.0);
\fill[black] (-1.0,0) circle (2.5pt);
\fill[black] (1.0,0) circle (2.5pt);
\node[below=3pt,font=\tiny] at (-1.0,0) {1};
\node[below=3pt,font=\tiny] at (1.0,0) {0};
\end{scope}

% QPSK
\begin{scope}[shift={(4.5,0)}]
\node[above,font=\sffamily\bfseries\small] at (0,2.0) {QPSK (2 bits/symbol)};
\draw[->] (-1.6,0) -- (1.6,0) node[right,font=\scriptsize] {$I$};
\draw[->] (0,-1.3) -- (0,1.3) node[above,font=\scriptsize] {$Q$};
\draw[very thin,gray!20] (-1.3,-1.0) grid[step=0.3] (1.3,1.0);
\fill[black] (0.75,0.75) circle (2.5pt);
\fill[black] (-0.75,0.75) circle (2.5pt);
\fill[black] (-0.75,-0.75) circle (2.5pt);
\fill[black] (0.75,-0.75) circle (2.5pt);
\node[above right=1pt,font=\tiny] at (0.75,0.75) {00};
\node[above left=1pt,font=\tiny] at (-0.75,0.75) {01};
\node[below left=1pt,font=\tiny] at (-0.75,-0.75) {11};
\node[below right=1pt,font=\tiny] at (0.75,-0.75) {10};
\end{scope}

% 16-QAM
\begin{scope}[shift={(9,0)}]
\node[above,font=\sffamily\bfseries\small] at (0,2.0) {16-QAM (4 bits/symbol)};
\draw[->] (-1.6,0) -- (1.6,0) node[right,font=\scriptsize] {$I$};
\draw[->] (0,-1.3) -- (0,1.3) node[above,font=\scriptsize] {$Q$};
\draw[very thin,gray!20] (-1.3,-1.0) grid[step=0.3] (1.3,1.0);
% Grid of 16 points
\foreach \x in {-0.95,-0.32,0.32,0.95} {
  \foreach \y in {-0.95,-0.32,0.32,0.95} {
    \fill[black] (\x,\y) circle (1.5pt);
  }
}
\node[below=8pt,font=\tiny,align=center] at (0,-1.3) {16 constellation\\points};
\end{scope}
