...
\node[below=8pt,font=\small,align=center] at (0,-0.5) {$\theta = 90°$};
\end{scope}
...
\node[below=8pt,font=\small,align=center] at (0,-0.5) {$\theta = 0°$};
\end{scope}
...
\node[below=8pt,font=\small,align=center] at (0,-0.5) {$\theta = 45°$};
\end{scope}
\end{tikzpicture}
\end{center}
...
\node[below=12pt,font=\small,align=center] at (0,-2) {$\Delta\phi = -90°$\\Clockwise};
\end{scope}
...
\draw[->,very thick,red] (1.3,0) arc (0:270:1.3cm);
\node[right=2pt,font=\small] at (1.3,0) {Start};
\node[below=12pt,font=\small,align=center] at (0,-2) {$\Delta\phi = +90°$\\Counter-clockwise};
\end{scope}
\end{tikzpicture}
\end{center}
...
% Axes labels
\draw[<->,dashed] (-2,0) -- (2,0) node[midway,above,font=\small] {$2A$ (major)};
\draw[<->,dashed] (0,-1.2) -- (0,1.2) node[midway,right,font=\small] {$2B$ (minor)};
...
% Poles
\filldraw[NavyBlue] (0,2) circle (2pt) node[above right,font=\small] {LHCP};
\filldraw[NavyBlue] (0,-2) circle (2pt) node[below right,font=\small] {RHCP};

% Equator points
\filldraw[red] (2,0) circle (2pt) node[right,font=\small] {H};
\filldraw[red] (-2,0) circle (2pt) node[left,font=\small] {V};
\filldraw[red] (0,0) circle (1pt);
\filldraw[red] (1.41,0) circle (1.5pt) node[above right,font=\scriptsize] {$+45°$};
\filldraw[red] (-1.41,0) circle (1.5pt) node[above left,font=\scriptsize] {$-45°$};

% Equator line
\draw[red,thick] (0,0) ellipse (2cm and 0.6cm);

\node[below,font=\small,align=center] at (0,-2.5) {\textbf{Equator:} Linear polarizations\\\textbf{Poles:} Circular polarizations};
\end{tikzpicture}
\end{center}
