...
% \item \textbf{Chapter~\ref{ch:modulation}:} Digital Modulation---impact on required SNR and spectral efficiency (chapter not yet available)
\item \textbf{Chapter~\ref{ch:fec}:} Forward Error Correction---coding gain reduces required margin
% \item \textbf{Chapter~\ref{ch:diversity}:} Antenna Diversity---improves margin in fading channels (chapter not yet available)
\end{itemize}
