...
\subsection{Evolution of PSK Modulation}

The progression from QPSK to 8PSK to 16-PSK illustrates the fundamental trade-off between spectral efficiency and noise immunity:

\begin{center}
\begin{tikzpicture}[scale=1.0]
% QPSK
\begin{scope}[shift={(0,0)}]
\node[above,font=\sffamily\bfseries] at (0,2.2) {QPSK};
\draw[->] (-1.5,0) -- (1.5,0) node[right,font=\sffamily\small] {$I$};
\draw[->] (0,-1.5) -- (0,1.5) node[above,font=\sffamily\small] {$Q$};
\draw[very thin,gray!30] (-1.2,-1.2) grid[step=0.4] (1.2,1.2);
\fill[black] (0.85,0.85) circle (2pt);
\fill[black] (-0.85,0.85) circle (2pt);
\fill[black] (-0.85,-0.85) circle (2pt);
\fill[black] (0.85,-0.85) circle (2pt);
\node[below=8pt,font=\scriptsize] at (0,-1.5) {4 points, 2 bits/symbol};
\node[below=18pt,font=\scriptsize] at (0,-1.5) {$90°$ spacing};
\end{scope}

% 8PSK
\begin{scope}[shift={(4.5,0)}]
\node[above,font=\sffamily\bfseries] at (0,2.2) {8PSK};
\draw[->] (-1.5,0) -- (1.5,0) node[right,font=\sffamily\small] {$I$};
\draw[->] (0,-1.5) -- (0,1.5) node[above,font=\sffamily\small] {$Q$};
\draw[very thin,gray!30] (-1.2,-1.2) grid[step=0.4] (1.2,1.2);
\fill[black] (1,0) circle (2pt);
\fill[black] ({cos(45)},{sin(45)}) circle (2pt);
\fill[black] (0,1) circle (2pt);
\fill[black] ({cos(135)},{sin(135)}) circle (2pt);
\fill[black] (-1,0) circle (2pt);
\fill[black] ({cos(225)},{sin(225)}) circle (2pt);
\fill[black] (0,-1) circle (2pt);
\fill[black] ({cos(315)},{sin(315)}) circle (2pt);
\draw[dashed,gray] (0,0) circle (1);
\node[below=8pt,font=\scriptsize] at (0,-1.5) {8 points, 3 bits/symbol};
\node[below=18pt,font=\scriptsize] at (0,-1.5) {$45°$ spacing};
\end{scope}

% 16-PSK
\begin{scope}[shift={(9,0)}]
\node[above,font=\sffamily\bfseries] at (0,2.2) {16-PSK};
\draw[->] (-1.5,0) -- (1.5,0) node[right,font=\sffamily\small] {$I$};
\draw[->] (0,-1.5) -- (0,1.5) node[above,font=\sffamily\small] {$Q$};
\draw[very thin,gray!30] (-1.2,-1.2) grid[step=0.4] (1.2,1.2);
\foreach \angle in {0,22.5,...,337.5}
  \fill[black] ({cos(\angle)},{sin(\angle)}) circle (2pt);
\draw[dashed,gray] (0,0) circle (1);
\node[below=8pt,font=\scriptsize] at (0,-1.5) {16 points, 4 bits/symbol};
\node[below=18pt,font=\scriptsize] at (0,-1.5) {$22.5°$ spacing};
\end{scope}
\end{tikzpicture}
\end{center}

\textbf{Key observation:} As $M$ increases, angular spacing decreases, making constellation points closer together and more susceptible to noise and phase errors. Each doubling of $M$ approximately adds 3.5--4~dB to the required $E_b/N_0$ for the same BER.
