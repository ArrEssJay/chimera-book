...
% Grid
\draw[very thin,gray!30] (-0.5,-1.5) grid[step=0.5] (2.5,1.5);
...
% Labels
\node[below=8pt,align=center] at (0,0) {\sffamily\small Bit 0\\$(0, 0)$\\OFF};
\node[below=8pt,align=center] at (2,0) {\sffamily\small Bit 1\\$(A, 0)$\\ON};

% Distance annotation
\draw[<->,thick] (0,0.8) -- (2,0.8) node[midway,above] {\sffamily\small $d = A$};
\end{tikzpicture}
\end{center}
...
\node[block, right of=input, node distance=2.5cm] (bpf) {Bandpass\\Filter};
\node[block, right of=bpf, node distance=2.8cm] (env) {Envelope\\Detector};
\node[block, right of=env, node distance=2.8cm] (lpf) {Lowpass\\Filter};
\node[block, right of=lpf, node distance=2.8cm] (thresh) {Threshold\\$>V_{th}?$};
...
\node[above,font=\sffamily\bfseries] at (0,2.8) {OOK (Binary ASK)};
\draw[->] (-0.5,0) -- (3,0) node[right,font=\sffamily\small] {$I$};
\draw[->] (0,-1.8) -- (0,1.8) node[above,font=\sffamily\small] {$Q$};
\draw[very thin,gray!30] (-0.3,-1.5) grid[step=0.5] (2.8,1.5);
\fill[black] (0,0) circle (3pt);
\fill[black] (2,0) circle (3pt);
\node[below=6pt,font=\scriptsize] at (0,0) {0};
\node[below=6pt,font=\scriptsize] at (2,0) {$A$};
\node[below=18pt,font=\small] at (1,-1.5) {$M=2$, 1 bit/symbol};
\end{scope}

% 2-ASK (Non-zero levels)
\begin{scope}[shift={(5,0)}]
\node[above,font=\sffamily\bfseries] at (0,2.8) {2-ASK};
\draw[->] (-0.5,0) -- (3,0) node[right,font=\sffamily\small] {$I$};
\draw[->] (0,-1.8) -- (0,1.8) node[above,font=\sffamily\small] {$Q$};
\draw[very thin,gray!30] (-0.3,-1.5) grid[step=0.5] (2.8,1.5);
\fill[black] (0.5,0) circle (3pt);
\fill[black] (2,0) circle (3pt);
\node[below=6pt,font=\scriptsize] at (0.5,0) {$A_1$};
\node[below=6pt,font=\scriptsize] at (2,0) {$A_2$};
\node[below=18pt,font=\small] at (1.25,-1.5) {$M=2$, 1 bit/symbol};
\end{scope}

% 4-ASK
\begin{scope}[shift={(10,0)}]
\node[above,font=\sffamily\bfseries] at (0,2.8) {4-ASK};
\draw[->] (-0.5,0) -- (3.5,0) node[right,font=\sffamily\small] {$I$};
\draw[->] (0,-1.8) -- (0,1.8) node[above,font=\sffamily\small] {$Q$};
\draw[very thin,gray!30] (-0.3,-1.5) grid[step=0.5] (3.3,1.5);
\fill[black] (0.5,0) circle (3pt);
\fill[black] (1.3,0) circle (3pt);
\fill[black] (2.1,0) circle (3pt);
\fill[black] (2.9,0) circle (3pt);
\node[below=6pt,font=\scriptsize] at (0.5,0) {$A_1$};
\node[below=6pt,font=\scriptsize] at (1.3,0) {$A_2$};
\node[below=6pt,font=\scriptsize] at (2.1,0) {$A_3$};
\node[below=6pt,font=\scriptsize] at (2.9,0) {$A_4$};
\node[below=18pt,font=\small] at (1.7,-1.5) {$M=4$, 2 bits/symbol};
\end{scope}
\end{tikzpicture}
\end{center}
